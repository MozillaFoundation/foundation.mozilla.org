...
class ReadMoreCategories {
  constructor(node) {
    this.readMore = node;
    this.toggleButton = this.readMore.querySelector('[data-yt-categories-toggle]');
    this.readMoreText = this.readMore.querySelector('[data-yt-categories-toggle-more]');
    this.readLessText = this.readMore.querySelector('[data-yt-categories-toggle-less]');
    this.plusIcon = this.readMore.querySelector('[data-yt-categories-plus-icon]');
    this.minusIcon = this.readMore.querySelector('[data-yt-categories-minus-icon]');
  ...
  handleOpen() {
    ...
    timeline
      .to(this.content, { duration: this.animateSpeed, height: 'auto' });
  }
  ...
  handleClose() {
    ...
    timeline
      .to(this.content, { duration: this.animateSpeed, height: '0px' });
  }
}
