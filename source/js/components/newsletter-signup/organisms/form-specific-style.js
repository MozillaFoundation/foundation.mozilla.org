...
export const FORM_STYLE = {
  ...
  "callout-box:2-col": {
    ...
    fieldStyle: "outlined",
    formContainerClass: "tw-w-full large:tw-w-1/2 large:tw-pl-24 tw-mt-8",
    headingLevel: 3,
    headingClass: "tw-h1-heading",
    innerWrapperClass: "tw-flex tw-flex-col large:tw-gap-8 large:tw-flex-row",
    introContainerClass: "tw-w-full large:tw-w-1/2 large:tw-pr-24",
  },
  "campaign-body": {
    buttonPosition: "bottom",
    buttonStyle: "primary",
