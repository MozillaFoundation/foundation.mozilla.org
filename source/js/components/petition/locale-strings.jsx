...
export default {
  ...
  en: {
    ...
    "Sign up": `Sign up`,
    "Protect the internet as a global public resource": `Protect the internet as a global public resource`,
    "Join our list": `<p>Join our <b>Mozilla News</b> email list to take action and stay updated!</p>`,
  ...
  de: {
    ...
    "Sign up": `Abonnieren`,
    "Protect the internet as a global public resource": `Schützen Sie das Internet als globale Ressource`,
    "Join our list": `<p>Werden Sie aktiv und abonnieren Sie die <b>Mozilla News</b> Liste für Updates!</p>`,
  ...
  es: {
    ...
    "Sign up": `Suscribirme`,
    "Protect the internet as a global public resource": `Protege Internet como recurso público mundial`,
  ...
  fr: {
    ...
    "Protect the internet as a global public resource": `Participez à la préservation d’Internet en tant que bien commun`,
    "Join our list": `<p>Recevez les <b>Actualités de Mozilla</b> par courriel pour vous tenir au courant et passer à l’action !</p>`,
  ...
  pl: {
    ...
    "Add my name": `Podpisz`,
    "Sign up": `Zapisz się`,
    "Protect the internet as a global public resource": `Chroń Internet jako globalny zasób publiczny`,
  ...
  "pt-BR": {
    ...
    "Sign up": `Inscreva-me`,
    "Protect the internet as a global public resource": `Defenda a internet como um recurso público global`,
    "Join our list": `<p>Inscreva-se na <b>Mozilla News</b> para participar de nossas ações e manter-se atualizado!</p>`,
