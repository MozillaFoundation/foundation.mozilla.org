...
export default {
  ...
  de: {
    ...
    "Sign up": `Abonnieren`,
    "Help shape the future of the web for the public good": `Schützen Sie das Internet als globale Ressource`,
  ...
  fr: {
    ...
    "Help shape the future of the web for the public good": `Participez à la préservation d’Internet en tant que bien commun`,
  ...
  pt: {
    ...
    "Sign up": `Inscreva-me`,
    "Help shape the future of the web for the public good": `Defenda a internet como um recurso público global`,
