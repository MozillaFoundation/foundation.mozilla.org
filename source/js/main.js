...
import { initMozfestHeroCarousel } from "./components/mozfest-hero-carousel/mozfest-hero-carousel";
...
let main = {
  ...
  initPageSpecificScript() {
    ...
    // Mozfest page
    if (document.querySelector("#view-mozfest-home")) {
      initMozfestHeroCarousel();
    }
  },
};
