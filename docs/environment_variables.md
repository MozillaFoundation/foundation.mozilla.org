...
| `GREENHOUSE_BOARD_ENABLED` | `False` | Master switch for the Greenhouse integration. While off, the board block renders nothing and the Careers footer links keep pointing at Corp's board |
