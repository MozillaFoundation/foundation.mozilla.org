...
module.exports = {
  ...
  ignoreFiles: [
    ...
    // Generated by tools/build-tokens.js, values come straight from LP's
    // token JSON verbatim. Not worth teaching the generator to chase
    // whatever formatting stylelint wants for hand-written SCSS.
    "../../foundation_cms/static/scss/_tokens.scss",
    "../../foundation_cms/static/scss/settings/_tokens.scss",
  ],
  rules: {
    "block-no-empty": true,
