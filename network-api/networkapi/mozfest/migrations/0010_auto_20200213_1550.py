...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(default='Submit proposal', help_text='Label text for the CTA button in the primary nav bar', max_length=250, null=True),
        ),
        migrations.AddField(
            model_name='mozfesthomepage',
        ...
        migrations.AddField(
            ...
            field=wagtail.core.fields.RichTextField(blank=True, help_text='Pre-footer content', null=True),
        ),
        migrations.AddField(
            model_name='mozfesthomepage',
