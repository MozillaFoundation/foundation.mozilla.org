# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-22 22:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('modularpage_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='minisites.ModularPage')),
            ],
            options={
                'abstract': False,
            },
            bases=('minisites.modularpage',),
        ),
        migrations.CreateModel(
            name='Petition',
            fields=[
                ('cta_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='minisites.CTA')),
        ...
        migrations.CreateModel(
            name='CampaignPage',
            fields=[
                ('minisitenamespace_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='minisites.MiniSiteNameSpace')),
                ('cta', models.ForeignKey(blank=True, help_text='Choose existing or create new sign-up form', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='page', to='minisites.Petition')),
            ],
            options={
                'abstract': False,
            },
            bases=('minisites.minisitenamespace',),
        ),
        migrations.CreateModel(
            name='OpportunityPage',
            fields=[
                ('minisitenamespace_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='minisites.MiniSiteNameSpace')),
                ('cta', models.ForeignKey(blank=True, help_text='Choose existing or create new petition form', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='page', to='minisites.Signup')),
            ],
            options={
                'abstract': False,
            },
