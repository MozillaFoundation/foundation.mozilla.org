# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-13 17:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='', help_text='Identify this component for other editors', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.core.fields.StreamField((('heading', wagtail.core.blocks.CharBlock()), ('paragraph', wagtail.core.blocks.RichTextBlock()), ('image_text', wagtail.core.blocks.StructBlock((('text', wagtail.core.blocks.CharBlock()), ('image', wagtail.images.blocks.ImageChooserBlock()), ('ordering', wagtail.core.blocks.ChoiceBlock(choices=[('left', 'Image on the left'), ('right', 'Image on the right')]))))), ('image', wagtail.images.blocks.ImageChooserBlock()), ('bio', wagtail.core.blocks.StructBlock((('text', wagtail.core.blocks.CharBlock()), ('image', wagtail.images.blocks.ImageChooserBlock()), ('ordering', wagtail.core.blocks.ChoiceBlock(choices=[('left', 'Image on the left'), ('right', 'Image on the right')])), ('name', wagtail.core.blocks.CharBlock())))), ('video', wagtail.embeds.blocks.EmbedBlock()), ('linkbutton', wagtail.core.blocks.StructBlock((('label', wagtail.core.blocks.CharBlock()), ('URL', wagtail.core.blocks.CharBlock())))), ('spacer', wagtail.core.blocks.StructBlock((('rem', wagtail.core.blocks.IntegerBlock()),)))))),
            ],
            options={
                'abstract': False,
            },
