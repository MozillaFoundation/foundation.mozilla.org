...
class ProductPage(AirtableMixin, FoundationMetadataPageMixin, Page):
    ...
    def get_context(self, request, *args, **kwargs):
        ...
        context['featured_cta'] = self.check_for_categories_featuring_cta()
    ...
    def check_for_categories_featuring_cta(self):
        if self.product_categories.filter(category__show_cta=True):
