...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='slug',
            field=models.SlugField(help_text='The slug is auto-generated from the name, but can be customized if needed. It needs to be unique per locale.', max_length=100, null=True),
        ),
        migrations.AddField(
