# Generated by Django 2.2.5 on 2019-10-08 23:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=networkapi.buyersguide.models.ExtendedYesNoField(choices=[('Yes', 'Yes'), ('No', 'No'), ('NA', 'Not Applicable'), ('U', 'Unknown')], default='U', help_text='Does this product collect biometric data?'),
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.AddField(
            model_name='product',
            name='privacy_policy',
            field=networkapi.buyersguide.models.ExtendedYesNoField(choices=[('Yes', 'Yes'), ('No', 'No'), ('NA', 'Not Applicable'), ('U', 'Unknown')], default='U', help_text='Does this product have a privacy policy?'),
        ),
        migrations.AddField(
            model_name='product',
            name='user_friendly_privacy_policy',
            field=networkapi.buyersguide.models.ExtendedYesNoField(choices=[('Yes', 'Yes'), ('No', 'No'), ('NA', 'Not Applicable'), ('U', 'Unknown')], default='U', help_text='Does this product have a user-friendly privacy policy?'),
        ),

        # What follows is a slew of fields that were using blank="True" rather than blank=True
