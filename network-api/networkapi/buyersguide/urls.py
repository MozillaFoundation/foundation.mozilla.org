...
urlpatterns = [
    ...
    re_path(r'^about/meets-minimum-security-standards', views.bg_about_page("minimum_security"), name='min-security-view'),
    re_path(r'^about/why', views.bg_about_page("why_we_made"), name='why-view'),
