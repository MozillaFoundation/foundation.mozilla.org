...
urlpatterns = [
    ...
    url(r'^about/meets-minimum-security-standards', views.bg_about_page("minimum_security"), name='explained-view'),
    url(r'^about/why', views.bg_about_page("why_we_made"), name='why-view'),
    url(r'^about/', views.bg_about_page("how_to_use"), name='about-view'),
