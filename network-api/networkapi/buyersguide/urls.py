...
urlpatterns = [
    ...
    url(r'^about/press', views.press_view, name='press-view'),
    url(r'^about/contact', views.contact_view, name='contact-view'),
    url(r'^about/methodology', views.methodology_view, name='methodology-view'),
    url(r'^about/meets-minimum-security-standards', views.explained_view, name='explained-view'),
