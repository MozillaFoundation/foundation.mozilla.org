...
fetchJSON(`pulse-privacy`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Online%20Privacy%20%26%20Security&featured=True`);
fetchJSON(`pulse-innovation`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Open%20Innovation&featured=True`);
fetchJSON(`pulse-inclusion`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Digital%20Inclusion&featured=True`);
fetchJSON(`pulse-decentralization`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Decentralization&featured=True`);
fetchJSON(`pulse-literacy`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Web%20Literacy&featured=True`);
