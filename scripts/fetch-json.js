...
fetchJSON(`pulse-inclusion`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Digital%20Inclusion&featured=True&page_size=2`);
fetchJSON(`pulse-decentralization`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Decentralization&featured=True&page_size=2`);
fetchJSON(`pulse-literacy`, `https://${environment[`PULSE_API_DOMAIN`]}/entries/?issue=Web%20Literacy&featured=True&page_size=2`);
