...
module.exports = {
  FA_FIELDS: {
    ...
    otherDetailsTextBox: `textarea[name="tfa_163"]`,
    name: `input[name="tfa_1"]`,
    email: `input[name="tfa_10"]`,
    screenshotField: `input[name="tfa_214"]`,
  },
  DROP_DOWN_OPTIONS: [
    { value: "tfa_194", has_image_field: true },
    { value: "tfa_195", has_image_field: false },
    { value: "tfa_193", has_image_field: false },
    { value: "tfa_192", has_image_field: false },
    { value: "tfa_196", has_image_field: false },
    { value: "tfa_197", has_image_field: true },
    { value: "tfa_190", has_image_field: false },
    { value: "tfa_191", has_image_field: false },
    { value: "tfa_198", has_image_field: false },
    { value: "tfa_199", has_image_field: false },
    { value: "tfa_200", has_image_field: true },
  ],
  FA_HIDDEN_FIELDS: {
