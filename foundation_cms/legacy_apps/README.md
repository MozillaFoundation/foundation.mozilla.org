# foundation.mozilla.org (Legacy Foundation Site)
...
See the [root README.md](../../README.md) for Django gotchas (e.g. `DEBUG=True`), the translations workflow, and contributing guidelines.
