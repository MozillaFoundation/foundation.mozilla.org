...
def generate_blog_newsletter_signup_field():
    from foundation_cms.legacy_apps.wagtailpages.factory.customblocks.newsletter_signup_block import (
        BlogNewsletterSignupBlockFactory,
    )
    from foundation_cms.legacy_apps.wagtailpages.pagemodels.customblocks.newsletter_signup_block import (
...
def generate_tickets_block_field():
    heading = fake.sentence(nb_words=10, variable_nb_words=True)
    tickets = []
    from foundation_cms.legacy_apps.mozfest.factory import TicketSnippetFactory
...
def generate_newsletter_signup_with_background_field():
    from foundation_cms.legacy_apps.mozfest.factory import (
