...
class BuyersGuidePageHeroSupportingPageRelationFactory(DjangoModelFactory):
    ...
    supporting_page = SubFactory(
        "foundation_cms.legacy_apps.wagtailpages.factory.buyersguide.BuyersGuideArticlePageFactory",
    )
...
class BuyersGuidePageFeaturedUpdateRelationFactory(DjangoModelFactory):
    ...
    page = SubFactory(BuyersGuidePageFactory)
    update = SubFactory(
        "foundation_cms.legacy_apps.wagtailpages.factory.buyersguide.ProductUpdateFactory",
    )
...
class ProductVoteFactory(DjangoModelFactory):
    ...
    evaluation = SubFactory("foundation_cms.legacy_apps.wagtailpages.factory.buyersguide.ProductPageEvaluationFactory")
...
class ProductPageCategoryFactory(DjangoModelFactory):
    ...
    product = SubFactory("foundation_cms.legacy_apps.wagtailpages.factory.buyersguide.ProductPageFactory")
    category = SubFactory(
        "foundation_cms.legacy_apps.wagtailpages.factory.buyersguide.BuyersGuideProductCategoryFactory"
    )
