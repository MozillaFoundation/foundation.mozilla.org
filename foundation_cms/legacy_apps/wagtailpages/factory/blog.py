...
class RelatedBlogPostsFactory(DjangoModelFactory):
    ...
    page = SubFactory("foundation_cms.legacy_apps.wagtailpages.factory.blog.BlogPageFactory")
    related_post = SubFactory("foundation_cms.legacy_apps.wagtailpages.factory.blog.BlogPageFactory")
