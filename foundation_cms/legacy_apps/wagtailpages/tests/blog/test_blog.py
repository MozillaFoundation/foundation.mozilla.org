...
class TestBlogPage(test.TestCase):
    ...
    @mock.patch("foundation_cms.legacy_apps.wagtailpages.pagemodels.blog.blog.BlogPage.get_missing_related_posts")
    ...
    @mock.patch("foundation_cms.legacy_apps.wagtailpages.pagemodels.blog.blog.BlogPage.ensure_related_posts")
