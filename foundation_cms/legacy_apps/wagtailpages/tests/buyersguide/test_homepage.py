...
from foundation_cms.legacy_apps.wagtailpages.pagemodels.buyersguide.article_page import (
    BuyersGuideArticlePage,
)
from foundation_cms.legacy_apps.wagtailpages.pagemodels.buyersguide.campaign_page import (
...
from foundation_cms.legacy_apps.wagtailpages.tests.buyersguide.base import (
    BuyersGuideTestCase,
)
