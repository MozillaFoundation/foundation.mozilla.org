...
from foundation_cms.legacy_apps.wagtailpages.pagemodels.libraries.rcc.landing_page import (
    RCCLandingPage,
)
from foundation_cms.legacy_apps.wagtailpages.pagemodels.libraries.research_hub.landing_page import (
    ResearchLandingPage,
)
