...
from foundation_cms.legacy_apps.wagtailpages.validators import RelativeURLValidator
...
class BaseLinkBlockAdapter(StructBlockAdapter):
    ...
    js_constructor = "foundation_cms.legacy_apps.wagtailpages.customblocks.BaseLinkBlock"
