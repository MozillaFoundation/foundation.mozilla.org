...
from foundation_cms.legacy_apps.wagtailpages.fields import ExtendedYesNoField
from foundation_cms.legacy_apps.wagtailpages.pagemodels.base import BasePage
from foundation_cms.legacy_apps.wagtailpages.pagemodels.buyersguide.categories import (
...
if typing.TYPE_CHECKING:
    from foundation_cms.legacy_apps.wagtailpages.models import BuyersGuideArticlePage
...
class ProductPage(BasePage):
    ...
    def get_meta_image_url(self, request):
        ...
        try:
            ...
            return static("legacy_apps/_images/buyers-guide/evergreen-social.png")
