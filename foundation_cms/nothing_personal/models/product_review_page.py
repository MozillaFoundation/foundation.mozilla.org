...
class NothingPersonalProductReviewPage(AbstractArticlePage, HeroImageMixin):
    ...
    search_fields = AbstractArticlePage.search_fields + [
        ...
        index.SearchField("byline", boost=3),
        index.SearchField("who_am_i", boost=2),
        ...
        index.SearchField("reduce_your_risks_section", boost=4),
        index.SearchField("bottom_line_section", boost=6),
        index.RelatedFields(
            "products_mentioned",
            [
                index.SearchField("mentioned_product__title", boost=3),
            ],
        ),
