...
const LOCALE_TEXT = {
  ...
  fr: {
    ...
    ccpaConfig: {
      description:
        "[CCPA intro for French] Je m’oppose à la vente et au partage de mes données personnelles",
      name: "Plus d’informations",
      rejectButton:
        "Je m’oppose à la vente et au partage de mes informations personnelles privées",
      ...CCPA_CONFIG_SHARED,
    },
  },
  // Frisian
