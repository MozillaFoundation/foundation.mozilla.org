...
BIO = (
    "<p>Priya Goswami works with communities to make technology more trustworthy, inclusive, and accountable. "
    "Their work brings together researchers, artists, organizers, and builders who want digital systems to "
    "serve people rather than extract from them. Priya has led international collaborations on responsible AI, "
    '<strong>public-interest technology</strong>, and the future of <a href="https://example.com/open-source">'
    "open source</a>.</p>"
    "<p>Across these projects, Priya focuses on turning complex technical questions into practical choices that "
    "communities can understand and influence. They regularly advise civic organizations, teach workshops, and "
    "publish accessible research about platform power and data governance. Her work connects policy, design, and "
    "community knowledge so that technical decisions remain accountable to the people they affect.</p>"
    "<p>Priya also works alongside local leaders to document how technology changes everyday civic life. These "
    ...
    "<p>Outside formal projects, Priya mentors emerging practitioners and helps interdisciplinary teams build "
    "lasting relationships across regions. She writes and speaks about responsible technology, open collaboration, "
    "and the institutional changes needed to sustain public-interest work.</p>"
)

PROFILE_FIELDS = {
    "title": "Priya Goswami",
    "role": "Mozilla Fellow & Privacy",
    "location": "ES",
    "affiliation": "University of State",
    "bio": BIO,
    "blurb": "Researcher and community organizer working toward accountable technology.",
    ...
    "seo_title": "Priya Goswami",
    "search_description": "Learn about Priya Goswami's work in public-interest technology.",
}
...
LINK_SECTIONS = [
    {
        ...
        "rows": [
            ...
            },
            {
                ...
                "description": "Recognition for community research and shared public learning.",
                "url": "",
            },
            {
                "id": "award-civic-collaboration",
    ...
    },
    {
        ...
        "rows": [
            ...
            {
                "id": "talk-accountable-ecosystems",
