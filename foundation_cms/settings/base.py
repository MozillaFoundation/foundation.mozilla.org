...
env = environ.Env(
    ...
    COMMONVOICE_NEWSLETTER_ENDPOINT=(str, ""),
    ...
    EXISTING_NEWSLETTER_SUBSCRIPTION_CHECK_ENDPOINT=(str, ""),
    EXISTING_NEWSLETTER_SUBSCRIPTION_CHECK_ENDPOINT_KEY=(str, ""),
    FEED_CACHE_TIMEOUT=(int, 60 * 60 * 24),
    FEED_LIMIT=(int, 10),
    FORCE_500_STACK_TRACES=(bool, False),
    FOUNDATION_NEWSLETTER_ENDPOINT=(str, ""),
    ...
    MOZFEST_NEWSLETTER_ENDPOINT=(str, ""),
...
FOUNDATION_NEWSLETTER_ENDPOINT = env("FOUNDATION_NEWSLETTER_ENDPOINT")
MOZFEST_NEWSLETTER_ENDPOINT = env("MOZFEST_NEWSLETTER_ENDPOINT")
COMMONVOICE_NEWSLETTER_ENDPOINT = env("COMMONVOICE_NEWSLETTER_ENDPOINT")
EXISTING_NEWSLETTER_SUBSCRIPTION_CHECK_ENDPOINT = env("EXISTING_NEWSLETTER_SUBSCRIPTION_CHECK_ENDPOINT")
EXISTING_NEWSLETTER_SUBSCRIPTION_CHECK_ENDPOINT_KEY = env("EXISTING_NEWSLETTER_SUBSCRIPTION_CHECK_ENDPOINT_KEY")
