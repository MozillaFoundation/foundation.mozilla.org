...
# Controls which user groups receive workflow notification emails
WAGTAILADMIN_NOTIFICATION_INCLUDE_SUPERUSERS = env("WAGTAILADMIN_NOTIFICATION_INCLUDE_SUPERUSERS", default=True)
WAGTAILADMIN_NOTIFICATION_INCLUDE_USERS_WITH_PAGE_PERMISSIONS = env(
    "WAGTAILADMIN_NOTIFICATION_INCLUDE_USERS_WITH_PAGE_PERMISSIONS", default=True
)
